    ...
    >
      ...
      <div className="relative mx-auto flex min-h-[calc(100vh-76px)] max-w-[1400px] items-center px-5 py-16 sm:px-8 lg:px-12 xl:px-20">
        <div className="max-w-3xl py-10 text-white">
          ...
          <h1 className="reveal-up delay-2 font-heading text-[3.6rem] font-semibold leading-[.92] tracking-[-.045em] text-white drop-shadow-[0_8px_30px_rgba(0,0,0,.28)] sm:text-[5.2rem] lg:text-[5.7rem] xl:text-[6.5rem]">
            Care that helps older persons{' '}
            <span className="text-accent-200">live with dignity.</span>
          </h1>

          <p className="reveal-up mt-7 max-w-2xl text-lg leading-8 text-white/85 drop-shadow-md">
          ...
          <div className="reveal-up mt-12 grid max-w-2xl grid-cols-3 gap-px border border-white/20 bg-white/20 shadow-2xl backdrop-blur-md">
